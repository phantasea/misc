...
if [[ ! -o vi ]]; then
  ...
  if [ $BASH_VERSINFO -gt 3 ]; then
    ...
    bind '"\C-t": " \C-u \C-a\C-k`__fzf_select_tmux__`\e\C-e\e\C-y\C-a\C-d\e\C-y\ey\C-h"'
  else
    bind '"\C-t": " \C-u \C-a\C-k`__fzf_select__`\e\C-e\e\C-y\C-a\e\C-y\ey\C-h\C-e\er \C-h"'
  fi

  # CTRL-R - Paste the selected command from history into the command line
  bind '"\C-r": " \C-e\C-u\e\C-y\ey\C-u`__fzf_history__`\e\C-e\er\e^"'
